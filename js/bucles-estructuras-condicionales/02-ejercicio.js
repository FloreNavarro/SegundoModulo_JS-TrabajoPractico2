// Escribir un programa que solicite una nota (número) de 0  a 10. Luego mostrar la calificación en un alert según 
...
const nota = parseInt(prompt("Ingrese de 0 a 10: "))
